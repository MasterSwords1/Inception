...
wp core install --path=/var/www/wordpress/ --allow-root --url='https://localhost:8080' --title=WordPress --admin_user=$WP_ADMIN --admin_password=$WP_ADMIN_PASS --admin_email=moulchi@example.com
